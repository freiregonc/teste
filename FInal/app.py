...
def tac1():
    ...
    #print(' {}min:{}sec'.format(t_min,t_sec)) #(t_hour,t_min,t_sec)
    auxpc.append("{}min:{}sec".format(t_min,t_sec))
    tempo = (' {}min:{}sec'.format(t_min,t_sec)) #(t_hour,t_min,t_sec)
    ...
    with mapa_face_mesh.FaceMesh(min_detection_confidence =0.5, min_tracking_confidence=0.5, refine_landmarks=True) as face_mesh:
        ...
        while True:
            ...
            if resultados.multi_face_landmarks:
                ...
                global olhosN
                olhosN = "olhos não detectados: " + tempo
                tac1()
            ...
            yield (b'--frame\r\n'
                   b'Content-Type: image/jpeg\r\n\r\n' + frame + b'\r\n')  # concatena os dados do quadro e retorna
...
def status():
    ...
    global olhosN
    global tempo
    return jsonify({'olhosD': olhosD, 'olhosC': olhosC, 'olhosE': olhosE, 'olhosF': olhosF, 'olhosN': olhosN})
